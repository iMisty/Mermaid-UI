 ...
 * @LastEditTime: 2021-03-17 14:48:34
 * @LastEditors: Miya
 * @Description: Carousel
 * @FilePath: \maid-chanc:\Users\Platinum Prism\Documents\GitHub\Mermaid-UI\package\carousel\Carousel.tsx
 * @Version: 1.0
 */
...
export default class MermaidCarousel extends Vue {
  private imgitem = [
    require('../../example/assets/1.png'),
    require('../../example/assets/2.png'),
    require('../../example/assets/3.png'),
    require('../../example/assets/4.png'),
    require('../../example/assets/5.png'),
    require('../../example/assets/6.png')
  ];
